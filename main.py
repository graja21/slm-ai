...
# Financial PDF chunked analysis is provided by the modular v18 router:
# financial_router.py -> financial_engine/*
# The previous in-file v17 parser and duplicate /financial-pdf-chunked route
# were removed to ensure FastAPI always uses the modular implementation.
